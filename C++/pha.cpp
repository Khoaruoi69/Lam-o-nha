...
void nhapThongTinSV(SV &sv, int id); // dung the sinh vien moi vao danh sach
void nhapSV(SV a[], int id, int n);// tt
void capNhatThongTinSV(SV &sv);// dung de cap nhap thong tin sinh vien theo iD
void capNhatSV(SV a[], int id, int n);// tt
